package im.mash.fastadapter.commons.utils;
...
import im.mash.fastadapter.commons.adapters.FastItemAdapter;
import im.mash.fastadapter.utils.ComparableItemListImpl;
...
public class FastAdapterDiffUtil {
    ...
    private static void collapseIfPossible(FastAdapter fastAdapter) {
        try {
            Class c = Class.forName("im.mash.fastadapter.expandable.ExpandableExtension");
            if (c != null) {
