package im.mash.fastadapter_extensions.dialog;
...
public class FastAdapterBottomSheetDialog<Item extends IItem> extends BottomSheetDialog {
     ...
     * @return this
     */
    public FastAdapterBottomSheetDialog<Item> withOnClickListener(im.mash.fastadapter.listeners.OnClickListener<Item> onClickListener) {
     ...
     * @return this
     */
    public FastAdapterBottomSheetDialog<Item> withOnPreClickListener(im.mash.fastadapter.listeners.OnClickListener<Item> onPreClickListener) {
