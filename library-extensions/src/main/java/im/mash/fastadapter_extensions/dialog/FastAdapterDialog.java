...
public class FastAdapterDialog<Item extends IItem> extends AlertDialog {
     ...
     * @return this
     */
    public FastAdapterDialog<Item> withOnClickListener(im.mash.fastadapter.listeners.OnClickListener<Item> onClickListener) {
     ...
     * @return this
     */
    public FastAdapterDialog<Item> withOnPreClickListener(im.mash.fastadapter.listeners.OnClickListener<Item> onPreClickListener) {
