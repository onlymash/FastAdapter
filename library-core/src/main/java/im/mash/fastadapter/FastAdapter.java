...
import im.mash.fastadapter.listeners.ClickEventHook;
import im.mash.fastadapter.listeners.EventHook;
import im.mash.fastadapter.listeners.LongClickEventHook;
import im.mash.fastadapter.listeners.OnBindViewHolderListener;
import im.mash.fastadapter.listeners.OnBindViewHolderListenerImpl;
import im.mash.fastadapter.listeners.OnClickListener;
import im.mash.fastadapter.listeners.OnCreateViewHolderListener;
import im.mash.fastadapter.listeners.OnCreateViewHolderListenerImpl;
import im.mash.fastadapter.listeners.OnLongClickListener;
import im.mash.fastadapter.listeners.OnTouchListener;
import im.mash.fastadapter.listeners.TouchEventHook;
import im.mash.fastadapter.select.SelectExtension;
import im.mash.fastadapter.utils.AdapterPredicate;
import im.mash.fastadapter.utils.DefaultTypeInstanceCache;
import im.mash.fastadapter.utils.EventHookUtil;
import im.mash.fastadapter.utils.Triple;
...
import static im.mash.fastadapter.adapters.ItemAdapter.items;
...
public class FastAdapter<Item extends IItem> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static <Item extends IItem> Item getHolderAdapterItem(@Nullable RecyclerView.ViewHolder holder) {
        if (holder != null) {
            Object tag = holder.itemView.getTag(im.mash.fastadapter.R.id.fastadapter_item_adapter);
